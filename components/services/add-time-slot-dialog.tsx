  ...
  return (
    <Dialog>
      <DialogTrigger>
        <div className="mb-4">
          <div
            className="flex flex-row items-center p-3 rounded-lg bg-red-100 hover:bg-red-200 text-red-800 border border-red-200 cursor-pointer border-none"
          >
      ...
      <DialogContent className="max-w-4xl p-0 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 h-full">
          ...
          <div className="bg-emerald-100 p-6 flex flex-col">
            ...
            <Button
              className="mt-4 bg-pink-200 hover:bg-pink-300 text-black"
